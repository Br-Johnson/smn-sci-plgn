...
4. Update the related skill if the live change affects behavior.
5. Update [docs/platform-gap-register.md](../../docs/platform-gap-register.md) if the drift changes parity risk.
6. Append the change to [kb/log.md](../log.md).
